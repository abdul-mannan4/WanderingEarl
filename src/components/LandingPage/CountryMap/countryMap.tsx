  ...
  return (
    <div className="relative z-0">
      <div className="pt-[50px] md:pt-[90px] 2xl:pt-[103px] relative">
        <div
          className="absolute -top-[100px] sm:-top-[120px] md:-top-[160px] 2xl:-top-[80px] -left-[60px] sm:-left-[60px] md:-left-[100px] 2xl:-left-[160px] -right-[60px] sm:-right-[60px] md:-right-[100px] 2xl:-right-[160px] -bottom-[100px] sm:-bottom-[120px] md:-bottom-[160px] 2xl:-bottom-[80px]
