  ...
  return (
    <section className="relative w-full bg-[#E8532B] overflow-hidden container !px-0">
      ...
      <svg className="absolute w-0 h-0" aria-hidden="true">
        <defs>
          {/* Desktop Curve: C-shaped bulge curving into the red text section */}
          <clipPath id="global-family-curve-desktop" clipPathUnits="objectBoundingBox">
            <path d="M 0.23,0 C 0.15,0.05 0,0.22 0,0.45 C 0,0.68 0.08,0.85 0.18,1 L 1,1 L 1,0 Z" />
          </clipPath>
          {/* Mobile Curve: Elegant bottom arch transitioning into the red section below */}
