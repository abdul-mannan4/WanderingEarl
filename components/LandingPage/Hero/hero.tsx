    ...
    <div className="container flex justify-start items-center box-border pt-[85px] min-[360px]:pt-[95px] min-[400px]:pt-[105px] min-[430px]:pt-[110px] sm:pt-[135px] md:pt-[160px] lg:pt-[180px] 2xl:pt-[303px]">
      ...
      <div className="flex flex-col gap-[12px] min-[360px]:gap-[16px] sm:gap-[24px] md:gap-[40px] lg:gap-[45px] xl:gap-[60px] w-full items-center text-center">
        ...
        <div className="flex flex-col gap-[4px] sm:gap-[6px] md:gap-[8px] xl:gap-[25px] items-center text-center w-full">
          <h1 className="font-sans font-black max-[300px]:whitespace-normal max-sm:whitespace-nowrap text-[17px] min-[360px]:text-[20px] min-[400px]:text-[23px] min-[430px]:text-[25px] sm:text-[32px] md:text-[40px] lg:text-[48px] xl:text-[64px] leading-[1.25] sm:leading-[1.2] lg:leading-[77px] text-white uppercase w-full flex justify-center items-center text-center">
            <span>
              UNIQUE, LOCAL, SMALL{" "}
          ...
          <p className="font-inter font-medium text-[13px] min-[360px]:text-[14px] sm:text-[15px] md:text-[18px] lg:text-[22px] xl:text-[24px] leading-[1.35] md:leading-[29px] text-white text-center drop-shadow-sm">
            Tours that show you something new.
          </p>
        </div>

        {/* Buttons Group - Scaled Comfortably for Mobile > 300px */}
        <div className="flex sm:flex-row flex-col gap-[9px] sm:gap-[12px] md:gap-[16px] justify-center items-center w-full">
