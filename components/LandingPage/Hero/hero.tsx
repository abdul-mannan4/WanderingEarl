...
export default function Hero() {
  return (
    <div className="container flex justify-start items-center box-border pt-[100px] md:pt-[160px] lg:pt-[180px] 2xl:pt-[303px]">
      ...
      <div className="flex flex-col gap-[24px]  sm:gap-[20px] md:gap-[40px]  lg:gap-[45px]  xl:gap-[60px] w-full  items-center text-center ">
        ...
        <div className="flex sm:flex-row flex-col gap-[8px]  justify-center items-center md:gap-[12px] sm:gap-[10px]">
          <button className="bg-primary-navy hover:bg-primary-navy-hover text-white font-inter font-semibold lg:leading-[22px] lg:text-[18px] md:text-[14px] text-[12px]
          md:leading-[18px]
          ...
          <button className="bg-accent-orange hover:bg-accent-orange-hover text-white font-inter font-semibold lg:leading-[22px] lg:text-[18px] md:text-[14px] text-[12px]
          md:leading-[18px]
          lg:pt-[16px] lg:pb-[16px] lg:px-[30px] 
          md:pt-[14px] md:pb-[14px] md:px-[28px]
           sm:pt-[12px] sm:pb-[12px] sm:px-[26px]
