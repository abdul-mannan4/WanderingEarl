...
export default function GlobalFamilySection() {
  return (
    <section className="relative w-full bg-[#E8532B] overflow-hidden container !px-0">
      <div className="w-full flex flex-col-reverse lg:flex-row justify-between items-center lg:items-stretch min-h-[400px] sm:min-h-[440px] lg:min-h-[460px] xl:min-h-[520px] 2xl:min-h-[580px] ">
        {/* Text Side - Increased text width on md to lg (max-w-[660px]) for balanced horizontal paragraph lines */}
        <div className="relative z-10 w-full lg:max-w-[560px] xl:max-w-[680px] 2xl:max-w-[742px] px-6 sm:px-10 lg:pl-[40px] xl:pl-[80px] lg:pr-6 py-10 sm:py-14 lg:py-16 xl:py-20 flex flex-col items-start lg:text-left justify-center gap-4 sm:gap-5 lg:gap-6">
          <h2 className="font-extrabold text-white text-[24px] sm:text-[34px] lg:text-[38px] xl:text-[44px] leading-tight uppercase tracking-tight">
            Our Global Family
          </h2>
          <p className="text-white/90 font-inter text-[14px] sm:text-[16px] xl:text-[18px] leading-relaxed max-w-[440px] md:max-w-[660px] lg:max-w-[460px] xl:max-w-[500px] 2xl:max-w-[742px]">
          ...
          <div className="pt-2 flex justify-center lg:justify-start">
            <button className="bg-[#0B2545] text-white font-medium text-[14px] sm:text-[14px] xl:text-[16px] px-5 py-2 sm:px-7 sm:py-3 xl:px-8 xl:py-3.5 rounded-full hover:bg-[#061830] transition-all shadow-md active:scale-95">
              Contact Us Today
            </button>
          </div>
        </div>
