...
export default function TeamPage() {
  return (
    <div className="pt-8 sm:pt-[52px] lg:pt-[100px] flex flex-col gap-[30px] sm:gap-[40px] md:gap-[52px] lg:gap-[120px] container">
        ...
        return (
          <div
            ...
            className={`flex flex-col ${isReversed ? "lg:flex-row-reverse" : "lg:flex-row"
              } items-center lg:items-start xl:items-center gap-4 lg:gap-[40px] xl:gap-[64px]`}
          >
            ...
            <div className="flex flex-col gap-2 lg:gap-[32px] xl:gap-[48px] font-inter text-text-dark text-[15px] sm:text-[16px] xl:text-[18px] leading-relaxed w-full flex-1 min-w-0">
              ...
              <div className="order-2 lg:order-1 flex flex-col gap-2 lg:gap-[20px] xl:gap-[24px]">
