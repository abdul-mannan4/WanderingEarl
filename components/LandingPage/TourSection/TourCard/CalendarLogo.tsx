...
export default function CalendarLogo() {
  return (
    <div>
      ...
      >
        <path 
          d="M3 10C3 7.6425 3 6.465 3.586 5.7325C4.172 5 5.114 5 7 5H17C18.886 5 19.828 5 20.414 5.7325C21 6.465 21 7.6425 21 10H3Z" 
          stroke="#885252" 
          strokeWidth="1.5"
        />
        <path 
          d="M19 5H5C3.89543 5 3 5.95513 3 7.13333V18.8667C3 20.0449 3.89543 21 5 21H19C20.1046 21 21 20.0449 21 18.8667V7.13333C21 5.95513 20.1046 5 19 5Z" 
          stroke="#885252" 
          strokeWidth="1.5"
        />
        <path 
        ...
        />
        <path 
          d="M16.5 16H13.5C13.2239 16 13 16.2239 13 16.5V17.5C13 17.7761 13.2239 18 13.5 18H16.5C16.7761 18 17 13.7761 17 13.5V16.5C17 16.2239 16.7761 16 16.5 16Z" 
          fill="#885252"
        />
      </svg>
    </div>
