...
export default function ContentCollage() {
  return (
    <div className='container mx-auto flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between gap-3 md:gap-4 lg:gap-8 xl:gap-10 2xl:gap-16 min-[1910px]:gap-[128px] px-4 sm:px-6 md:px-12 lg:px-12 2xl:px-16 min-[1910px]:!px-[208px]  pb-12 py-[40px] md:py-[52px] lg:pb-[140px]'>
      {/* Text Section */}
      <div className='flex flex-col gap-2 lg:gap-4 2xl:gap-5 min-[1910px]:gap-6 w-full flex-1 max-w-full lg:max-w-[614px] font-inter font-medium text-text-dark text-[14px] sm:text-[18px] lg:text-[18px] 2xl:text-[19px] min-[1910px]:text-[20px] leading-relaxed lg:text-left'>
      ...
      <div className="w-full  lg:w-[480px] xl:w-[540px] 2xl:w-[640px] min-[1910px]:w-[740px] shrink-0 mb-6 sm:mb-10 lg:mb-0">
        <AboutUSCollage />
      </div>
    </div>
  )
