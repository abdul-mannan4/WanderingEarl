  ...
  return (
    <div className="relative w-full min-h-[480px] sm:min-h-[500px] lg:min-h-0 lg:w-1/2 lg:aspect-square overflow-hidden shrink-0 rounded-2xl sm:rounded-3xl lg:rounded-none shadow-lg lg:shadow-none">
      ...
      <div className={`absolute inset-0 flex flex-col justify-end p-6 sm:p-8 lg:pb-8 xl:pb-12 2xl:pb-[60px] ${paddingX} text-white`}>
        <h3 className="text-2xl sm:text-3xl lg:text-2xl xl:text-3xl 2xl:text-[40px] font-bold uppercase mb-3 sm:mb-4 lg:mb-4 xl:mb-6 2xl:mb-[40px] leading-tight 2xl:leading-[48px] drop-shadow-sm">
          {highlightedWord ? (
            <>
        ...
        {paragraphs.map((p, i) => (
          <p
            key={i}
            className={`text-xs sm:text-sm lg:text-xs xl:text-sm 2xl:text-[20px] leading-relaxed 2xl:leading-[36px] font-inter font-medium text-white/90 ${i < paragraphs.length - 1 ? 'mb-3 sm:mb-4 lg:mb-4 xl:mb-6 2xl:mb-[40px]' :
